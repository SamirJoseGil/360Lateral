...
import type { ApiLoginData } from "~/services/authNew";
...
export const action = async ({ request }: ActionFunctionArgs) => {
  try {
    ...
    const loginData: ApiLoginData = { email, password };
...
export default function Login() {
  ...
  const [formData, setFormData] = useState<ApiLoginData>({
    email: "",
    password: "",
  });
