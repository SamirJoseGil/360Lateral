                                ...
                                <div key={favorite.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                                    <div className="p-6">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {/* ✅ NUEVO: Botón de Análisis MapGIS */}
                                            {lote.cbml && lote.cbml.length === 14 && (
                                                <Link
                                                    to={`/developer/analisis/${favorite.id}`}
                                                    className="flex-1 text-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center gap-1"
                                                    title="Analizar con MapGIS"
                                                >
