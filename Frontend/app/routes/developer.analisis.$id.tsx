...
export async function loader({ request, params }: LoaderFunctionArgs) {
    ...
    try {
        ...
        return redirect("/developer/analisis");
    }
}

export default function DeveloperAnalisisDetalle() {
                        ...
                        <div className="space-y-2">
                            {analisis.archivo_informe && (
                                <a
                                    ...
                                    className="block w-full text-center px-4 py-2 border-2 border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors"
                                >
                                    Descargar Informe
                                </a>
                            )}
