    ...
    const getNotificationIcon = (type: string) => {
        switch (type) {
            ...
            return (
                ...
                <path d="M7 13l3 3 7-7" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
            );
            case 'lote_rechazado':
            ...
            return (
                ...
                <path d="M7 13l3 3 7-7" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
            );
            ...
            return (
                ...
                <path d="M8 11h8M8 15h5" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" />
                <path d="M3 7l9 6 9-6" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
            );
            default:
            return (
                ...
                <path d="M12 8v4m0 4h.01" stroke="#6B7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            );
        }
    };
