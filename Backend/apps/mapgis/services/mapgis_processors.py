...
class MapGISProcessors:
    ...
    @staticmethod
    def procesar_datos_uso_suelo(resultados: List[Dict]) -> Dict:
        """
        Procesa los datos de uso del suelo
        
        Args:
            resultados: Lista de resultados de la consulta
            
        Returns:
            Dict con datos de uso del suelo procesados
        """
        try:
            uso_data = {}
    ...
    @staticmethod
    def procesar_datos_aprovechamiento(resultados: List[Dict]) -> Dict:
        """
        ...
        Returns:
            Dict con datos de aprovechamiento procesados
        """
        try:
    ...
    def procesar_datos_clasificacion(data: Dict) -> Dict:
        ...
        Args:
            data: Datos de la consulta de clasificación
            
        Returns:
            Dict con clasificación procesada
        """
        try:
    ...
    def procesar_datos_area(data: Dict) -> Dict:
        ...
        Args:
            data: Datos de la consulta de área
            
        Returns:
            Dict con área procesada
        """
        try:
            if data.get('resultados') and len(data['resultados']) > 0:
    ...
    def consolidar_datos_completos(resultado_base: Dict, consultas_adicionales: Dict) -> Dict:
        ...
        Args:
            resultado_base: Datos base del resultado
            consultas_adicionales: Diccionario con resultados de consultas adicionales
