...
**Ubicación**: `apps/users/serializers.py`
...
**Ubicación**: `apps/users/services.py`
...
**Ubicación**: `apps/users/signals.py`
...
**Ubicación**: `apps/users/permissions.py`
...
Searched codebase for "Perfecto, sigamos con users #file:users.md #codebase ", 1 result

Voy a crear la documentación completa del módulo de Users.
