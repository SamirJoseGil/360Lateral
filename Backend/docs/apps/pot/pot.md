...
**Ubicación**: `apps/pot/serializers.py`
...
**Ubicación**: `apps/pot/services.py`
...
Searched codebase for "Perfecto, sigamos con el pot #file:pot.md #codebase ", 1 result

Voy a crear la documentación completa del módulo de POT (Plan de Ordenamiento Territorial).
