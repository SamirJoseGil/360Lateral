...
**Ubicación**: `apps/lotes/serializers.py`
...
**Ubicación**: `apps/lotes/views.py`

#### Endpoint

Searched codebase for "Perfecto, sigamos con los lotes: #file:lotes.md #codebase ", no results

Voy a crear la documentación completa del módulo de Lotes.
